...
bin/client: src/client.c libINET.a src/reqRep.c src/dial.c src/users.c src/physic.c src/map.c src/graphics.c src/render.c src/update.c
	@echo "Compilation du client"
	mkdir -p build
	mkdir -p bin
	gcc $(CCFLAGS) $(CFLAGS) src/client.c src/reqRep.c src/dial.c src/users.c src/physic.c src/map.c src/graphics.c src/render.c src/update.c $(LDFLAGS) -DCLIENT -o bin/client
