...
bin/client: src/client.c libINET.a src/reqRep.c src/dial.c src/users.c src/map.c
	@echo "Compilation du client"
	mkdir -p build
	mkdir -p bin
	gcc $(CCFLAGS) $(CFLAGS) src/client.c src/reqRep.c src/dial.c src/users.c src/map.c $(LDFLAGS) -DCLIENT -o bin/client
